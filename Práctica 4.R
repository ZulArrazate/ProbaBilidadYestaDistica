...
#344 esa la observación y 9 son variables
dim(penguins)

#nombre de las variables
colnames(penguins)

#me indica el tipo de variable
str(penguins) 
...
# 1.- Creación de un vector de color
color=c("cyan", "darkmagenta", "chartreuse")

# 2.- Creación del gráfico
GB1<-ggplot(penguins, aes(x=año))+
  geom_bar(colour= "coral1", fill=color)+
...
HG<-ggplot(penguins, aes(x=largo_aleta_mm))+
  geom_histogram(col="deeppink", fill="pink")+
  ggtitle("Histograma")+
